public class Instruction {
    OpCode opCode ;	/*campi di instruction: ogni instruction è composta da un OpCode(preso dell'enum OpCode) e, talvolta, anche da un operando*/
    int operand ;
    
    public Instruction ( OpCode opCode) {   /*costruttori*/
        this.opCode = opCode;
    }
    ...
    public String toJasmin () { /*metodo toJasmin che ritrona una stringa nel formato istruzione "OpCode (openando)" */
        String temp="";
        
        switch (opCode) {   /*gestisce i vari casi (tutte le operazioni possibili nel linguaggio P)*/
