...
public class Lexer {
	/*
	 Consideriamo la seguente versione modificata della produzione per <stmt>:
		<stmt> ::= ID := <expr>
					| print (<expr>) 
					| if <expr> then <stmt>
					| while <expr> do <stmt> 
	...
	nel linguaggio modificato (cioè nel linguaggio con la versione modificata della produzione per <stmt>). 
