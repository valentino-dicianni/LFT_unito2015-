...
public class CodeGenerator {
    ...
    public void toJasmin () throws IOException {
        ...
        while(instructions.size() > 0){ //scorre la lista di istruzioni
            ...
            temp = temp + tmp.toJasmin();   //concatena la stringa temp con la nuova stringa tmp restituita dal metodo toJasmin in Instruction.java
        }
        temp = temp +  footer;  //concatena la stringa finale
